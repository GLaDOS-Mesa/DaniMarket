<template>
  ...
  >
    ...
    <div class="flex flex-col gap-3">
      ...
      <button
        type="button"
        class="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-primary-600 text-white font-medium rounded-lg hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-colors"
        @click="$emit('edit')"
      >
        <svg
          class="w-5 h-5"
      ...
      <div class="flex gap-2">
        ...
        >
          ...
          <span
            v-else
            class="w-5 h-5 border-2 border-gray-500 border-t-transparent rounded-full animate-spin"
            aria-hidden="true"
          />
          Duplica
        </button>
